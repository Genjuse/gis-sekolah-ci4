    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-sm-2">
          <div class="form-group">
            <label>NPSN</label>
            <input name="npsn" placeholder="NPSN" class="form-control">
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            <input name="kurikulum" placeholder="Kurikulum" class="form-control">
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            <input name="sk_pendirian_sekolah" placeholder="sk_pendirian_sekolah" class="form-control">
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            <input name="tgl_sk_pendirian" placeholder="tgl_sk_pendirian" class="form-control datepicker datepicker-tgl-sk-pendirian">
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            <input name="sk_izin_operasional" placeholder="sk_izin_operasional" class="form-control">
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            <input name="tgl_sk_izin_operasi" placeholder="tgl_sk_izin_operasi" class="form-control datepicker datepicker-tgl-sk-izin-operasi">
